...
public class EGA_Laser : MonoBehaviour
{
    ...
    public static Vector2 LAserENDPOINT;
    ...
    void Update()
    {
        ...
        if (Laser != null && UpdateSaver == false)
        {
           ...
           //  RaycastHit hit; //DELATE THIS IF YOU WANT USE LASERS IN 2D
            ...
            // if (Physics.Raycast(this.transform.position, transform.TransformDirection(Vector3.up), out hit, MaxLength))
            if (hit.collider != null)
            {
                //End laser position if collides with object
               
                Laser.SetPosition(1, new Vector3(0,0, hit.point.y));
