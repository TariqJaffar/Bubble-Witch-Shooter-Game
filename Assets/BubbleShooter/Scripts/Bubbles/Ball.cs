...
public class Ball : MonoBehaviour
{
    ...
    IEnumerator FlyToTarget()
    {
        if (itemKind.itemType == ItemTypes.Cub)
        {
            if (mainscript.Instance.currentLevel == 3 || mainscript.Instance.currentLevel == 6 || mainscript.Instance.currentLevel == 9 || mainscript.Instance.currentLevel == 10)
            {
                ...
                if (itemKind.color == ItemColor.YELLOW)
                {
                    Instantiate(mainscript.Instance.cubPrefab[0], transform.position, Quaternion.identity);
                    GetComponent<SpriteRenderer>().sprite = cubGui;
                    GetComponent<Transform>().localScale = new Vector3(0.15f, 0.15f, 0.15f);
                }
                else
                  if (itemKind.color == ItemColor.GREEN)
                {
                    Instantiate(mainscript.Instance.cubPrefab[1], transform.position, Quaternion.identity);
                    GetComponent<SpriteRenderer>().sprite = cubGui;
                    GetComponent<Transform>().localScale = new Vector3(0.15f, 0.15f, 0.15f);

                }
                else
                  if (itemKind.color == ItemColor.ORANGE)
                {
                    Instantiate(mainscript.Instance.cubPrefab[2], transform.position, Quaternion.identity);
                    GetComponent<SpriteRenderer>().sprite = cubGui;
                    GetComponent<Transform>().localScale = new Vector3(0.15f, 0.15f, 0.15f);

                }
                else
                  if (itemKind.color == ItemColor.VIOLET)
                {
                    Instantiate(mainscript.Instance.cubPrefab[3], transform.position, Quaternion.identity);
                    GetComponent<SpriteRenderer>().sprite = cubGui;
                    GetComponent<Transform>().localScale = new Vector3(0.15f, 0.15f, 0.15f);

                }
                else
                  if (itemKind.color == ItemColor.BLUE)
                {
                    Instantiate(mainscript.Instance.cubPrefab[4], transform.position, Quaternion.identity);
                    GetComponent<SpriteRenderer>().sprite = cubGui;
                    GetComponent<Transform>().localScale = new Vector3(0.15f, 0.15f, 0.15f);
    ...
    {
        if (coll.gameObject.tag == "Animation")
        {
            Debug.LogError("yahhhh");
            AnimateBall();
        }
    ...
    void AnimateBall()
    {
        ...
        gameObject.layer = 19;
        // gameObject.GetComponent<Animation>().Play("Falling");
        transform.DOMoveX(-1.5f, 0.5f).OnComplete(() => { moveInPositiveX(); });
        transform.DOMoveY(-7f, 4f);
        transform.DOScale(new Vector3(0.3f, 0.3f, 0.3f), 4f);
    }
    public void moveInNegativeX()
    {
        transform.DOMoveX(-0.15f, .5f);
    }
    public void moveInPositiveX()
    {
        transform.DOMoveX(1.5f, .5f).OnComplete(() => { moveInNegativeX(); }); ;
    }
    ...
    public void ExplEffect()
    {
        ...
        if (itemKind.color == ItemColor.RED)
        {
            i = 3;
        }
        ...
        GameObject explosion = (GameObject)Instantiate(BubbleExplosion[i], gameObject.transform.position, Quaternion.identity);
